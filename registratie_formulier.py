...
def gegevens(voornaam,achternaam,leeftijd,email):
    dic['Voornaam'] = voornaam
    dic['Achternaam'] = achternaam
    dic['Leeftijd'] = leeftijd
    dic['e-mail'] = email
    with open('C:/Users/timo/Documents/GitHub/file-communicate/databron/new_file.json', 'w') as file:
    ...
    gegevens_buttons(email,voornaam,achternaam,leeftijd)

def gegevens_buttons(email,voornaam,achternaam,leeftijd):
